...
if os.path.exists("creds.json"):
    ...
    # This pulls from GitHub Actions Secrets if the file is missing
    google_creds = os.getenv("GOOGLE_SHEETS_CREDS")
    if google_creds:
        creds_dict = json.loads(google_creds)
        creds = Credentials.from_service_account_info(creds_dict, scopes=scope)
    else:
        raise Exception("❌ CRITICAL: No Google Credentials found (creds.json or Secret).")
...
if new_records:
    ...
    try:
        # Now 'sheet' is properly defined above
